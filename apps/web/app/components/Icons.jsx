// Inline SVG icons — no external CDN dependency needed.
// All icons accept `size` and `color` props.

export function IconCamera({ size = 26, color = "currentColor" }) {
  return (
...
export function IconX({ size = 15, color = "currentColor" }) {
  return (
...
export function IconTrend({ size = 16, color = "currentColor" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
